...
public final class Bootstrap {
  public static void main(String[] args) {
    ...
    try {
      ...
      File jar = new  File("D:/workdir/workspace/Test/bin/a.jar");
      loader.addRepository(jar.toURI().toURL().toString());
      WebappClassLoader classLoader = (WebappClassLoader) loader.getClassLoader();
      System.out.println("Resources' docBase: " + ((ProxyDirContext)classLoader.getResources()).getDocBase());
      Class<?> lclz = classLoader.loadClass("com.TestMain");
      System.out.println("class' loader: " + lclz.getClassLoader());
